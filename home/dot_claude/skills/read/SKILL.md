---
name: read
description: Invoke when given any URL, web page link, or PDF to read. Fetches the content as clean Markdown using local tools only and saves to Downloads. Not for local files already in the repo.
metadata:
  version: "3.5.0"
---
